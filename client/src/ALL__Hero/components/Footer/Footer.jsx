    ...
    <footer className="footer">
      <Container>
        <Row>
          ...
          <Col lg="3" md="6" className="mb-4">
            <h2 className="fw-bold text-white">Explore</h2>
          ...
          <Col lg="3" md="6" className="mb-4">
            <h2 className="fw-bold text-white">Information</h2>
            <ListGroup className="link__list">
          ...
          <Col lg="3" md="6">
            ...
            <p className=" text-white">Address: Sylhet, Bangladesh</p>
            <p className=" text-white"> Phone: +88 0123456789 </p>
